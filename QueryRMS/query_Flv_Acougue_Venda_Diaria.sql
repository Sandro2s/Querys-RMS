...
Select 
     ...
     ,case  when to_char(dt_compl,'dd') = '01' then to_number(to_char((qtd_vda / git_emb_for)))end as A 
     ,case  when to_char(dt_compl,'dd') = '02' then to_number(to_char((qtd_vda / git_emb_for)))end as B
     ,case  when to_char(dt_compl,'dd') = '03' then to_number(to_char((qtd_vda / git_emb_for)))end as C
     ,case  when to_char(dt_compl,'dd') = '04' then to_number(to_char((qtd_vda / git_emb_for)))end as D
     ,case  when to_char(dt_compl,'dd') = '05' then to_number(to_char((qtd_vda / git_emb_for)))end as E
     ,case  when to_char(dt_compl,'dd') = '06' then to_number(to_char((qtd_vda / git_emb_for)))end as F
     ,case  when to_char(dt_compl,'dd') = '07' then to_number(to_char((qtd_vda / git_emb_for)))end as G
     ,case  when to_char(dt_compl,'dd') = '08' then to_number(to_char((qtd_vda / git_emb_for)))end as H
     ,case  when to_char(dt_compl,'dd') = '09' then to_number(to_char((qtd_vda / git_emb_for)))end as I
     ,case  when to_char(dt_compl,'dd') = '10' then to_number(to_char((qtd_vda / git_emb_for)))end as J
     ,case  when to_char(dt_compl,'dd') = '11' then to_number(to_char((qtd_vda / git_emb_for)))end as L
     ,case  when to_char(dt_compl,'dd') = '12' then to_number(to_char((qtd_vda / git_emb_for)))end as M
     ,case  when to_char(dt_compl,'dd') = '13' then to_number(to_char((qtd_vda / git_emb_for)))end as N
     ,case  when to_char(dt_compl,'dd') = '14' then to_number(to_char((qtd_vda / git_emb_for)))end as P
     ,case  when to_char(dt_compl,'dd') = '15' then to_number(to_char((qtd_vda / git_emb_for)))end as Q
     ,case  when to_char(dt_compl,'dd') = '16' then to_number(to_char((qtd_vda / git_emb_for)))end as R
     ,case  when to_char(dt_compl,'dd') = '17' then to_number(to_char((qtd_vda / git_emb_for)))end as S
     ,case  when to_char(dt_compl,'dd') = '18' then to_number(to_char((qtd_vda / git_emb_for)))end as T
     ,case  when to_char(dt_compl,'dd') = '19' then to_number(to_char((qtd_vda / git_emb_for)))end as U
     ,case  when to_char(dt_compl,'dd') = '20' then to_number(to_char((qtd_vda / git_emb_for)))end as V
     ,case  when to_char(dt_compl,'dd') = '21' then to_number(to_char((qtd_vda / git_emb_for)))end as X
     ,case  when to_char(dt_compl,'dd') = '22' then to_number(to_char((qtd_vda / git_emb_for)))end as Z
     ,case  when to_char(dt_compl,'dd') = '23' then to_number(to_char((qtd_vda / git_emb_for)))end as AA
     ,case  when to_char(dt_compl,'dd') = '24' then to_number(to_char((qtd_vda / git_emb_for)))end as AB
     ,case  when to_char(dt_compl,'dd') = '25' then to_number(to_char((qtd_vda / git_emb_for)))end as AC
     ,case  when to_char(dt_compl,'dd') = '26' then to_number(to_char((qtd_vda / git_emb_for)))end as AD
     ,case  when to_char(dt_compl,'dd') = '27' then to_number(to_char((qtd_vda / git_emb_for)))end as AE
     ,case  when to_char(dt_compl,'dd') = '28' then to_number(to_char((qtd_vda / git_emb_for)))end as AF
     ,case  when to_char(dt_compl,'dd') = '29' then to_number(to_char((qtd_vda / git_emb_for)))end as AG
     ,case  when to_char(dt_compl,'dd') = '30' then to_number(to_char((qtd_vda / git_emb_for)))end as AH
     ,case  when to_char(dt_compl,'dd') = '31' then to_number(to_char((qtd_vda / git_emb_for)))end as AI
