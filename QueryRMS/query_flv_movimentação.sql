...
-- Descrição : Movimentações da seção (FLV : 300, Acougue:305, Frios Laticinios:302)
...
select
           ...
           ( ( Select     id_dt
                   ...
                   from agg_mvto_prod ,
                   (select id_dt as dt,dt_compl from dim_per dim where dt_compl between to_date('&Dt_Inicial','dd/mm/yyyy') and to_date('&Dt_Final','dd/mm/yyyy')),
                   (select git_cod_item ,git_digito,git_descricao from aa3citem item where git_secao = '&secao')aa
                    where id_dt = dt
                  ...
                  ,vl_cmp
                     ...
                     from agg_cmp_prod,
                      ...
                      (select git_cod_item ,git_digito,git_descricao from aa3citem item where git_secao = '&secao')aa
                       where id_dt = dt
                        and cd_prod = aa.git_cod_item ))
              group by cd_fil,cd_prod,git_descricao
