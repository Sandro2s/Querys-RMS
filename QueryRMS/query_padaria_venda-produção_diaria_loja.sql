...
select 
  ...
  from aa3citem  
     where git_secao in (108,112,301,302,303,304,306)
      and git_cod_item||git_digito in (
        2151,2160,16144,17396,17620,17710,17736,17833,18023,19577,20958,
       22390,22888,22926,23922,23965,24023,24040,24759,31658,32670,37583,
       37591,37605,37621,37630,37648,37656,37664,37672,37796,38032,38784,
       38792,38814,38822,39004,39098,39101,39128,39136,39241,39250,39276,
       39292,39306,39314,39470,39624,40550,40991,41017,41157,49522,49948,
       62219,3156559
        ))aa
